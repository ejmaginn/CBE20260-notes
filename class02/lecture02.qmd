...
1. Describe basic thermodynamic definitions involving **systems** and **boundaries**.
2. Explain the difference between **equilibrium** and **steady-state**
3. Understand concepts of **energy**, **work**, and a **thermodynamic process**.
4. State the **First Law of Thermodynamics** both in words and mathematically.  
...
1. **Natural**: *temperature* $T$: Kelvin ($K$), Fahrenheit ($F$), Celsius ($C$); *pressure* $P$: pa, psi, bar, etc.
2. **Molar**: *molar volume* $\underline{V}$: $m^3/mol$; *molar energy* $\underline{E}$: kJ/mol
3. **Specific**: *specific volume* $\hat{V}$: $m^3/kg$; *specific energy* $\hat{E}$: BTU/lb
...
> It has been *observed* that energy is a *conserved quantity*. After a thermodynamic process occurs, the *energy of the system and surroundings is the same.*
>  

"**Conservation** (the conservation law) means this … that there is a number, which you can calculate, at one moment—and as nature undergoes its multitude of changes, this number doesn't change. That is, if you calculate again, this quantity, it'll be the same as it was before. An example is the conservation of energy: there's a quantity that you can calculate according to a certain rule, and it comes out the same answer after, no matter what happens."
 Richard Feynman
...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ejmaginn/CBE20260-notes/blob/main/class02/lecture02_example.ipynb)
