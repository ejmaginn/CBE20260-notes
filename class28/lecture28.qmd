...
## Jupyter Notebook Example - Reduced van der Waals Isotherms
I have prepared a Jupyter Notebook that solves the reduced van der Waals equation (@eq-vdwreduced) for $V_r$ and plots $Z$ versus $P_r$ for several reduced temperatures, reproducing @fig-vdw-Zr. Try adding isotherms closer to $T_r = 1$ to see how sharply $Z$ drops near the critical point.

::: {.content-visible when-format="html"}

[**View Interactive Notebook (.ipynb)**](vdw_Z_vs_Pr_isotherms.ipynb)

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ejmaginn/CBE20260-notes/blob/main/class28/vdw_Z_vs_Pr_isotherms.ipynb)
