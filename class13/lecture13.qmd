...
## Jupyter Notebook Example - Ideal Gas Entropy Calculator
I have prepared a Jupyter Notebook that uses @eq-S_ideal_TV to calculate the entropy change of an ideal gas with constant $C_v$ between two states $(T_1, \underline{V}_1)$ and $(T_2, \underline{V}_2)$, and plots the process on a $P$-$\underline{V}$ diagram. The example is an isothermal doubling of the volume. Try changing the temperatures and volumes to see how each term contributes to $\Delta S$.

::: {.content-visible when-format="html"}

[**View Interactive Notebook (.ipynb)**](Entropy-calculator-IG.ipynb)

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ejmaginn/CBE20260-notes/blob/main/class13/Entropy-calculator-IG.ipynb)
