---
title: "Lecture 12: Introduction to Entropy and the Second Law"
...
![Gas can spontaneously flow out of a tank, but not back in.](images/tank-emptying.png){#fig-tank-emptying width=60%}
...
![Blocks in contact at different temperatures equalize their temperatures; the reverse (spontaneous heating and cooling) is forbidden by the Second Law.](images/magic-fridge.png){#fig-magic-fridge width=60%}
...
![Pure substances mix spontaneously but never unmix.](images/gas-mixing.png){#fig-gas-mixing width=60%}
...
To account for this "directionality," we postulate the existence of a new property which is called 
**Entropy ($S$)**.
