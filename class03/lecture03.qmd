...
In addition to moving objects up and down, there are three other important kinds of work.

1. **Expansion-contraction work**: Typically a fluid expanding or contracting to raise or lower a piston or move an object.
2. **Flow work**: Associated with fluids flowing into and out of something.
3. **Shaft work**: Work associated with some mechanical device; we often represent it as an agitator or impeller attached to a shaft, hence the name. Common examples of equipment that involve shaft work are pumps, compressors, turbines, and mixers.
...
We have analyzed "boundary work" for a *closed* system, $W_{b} = -\int P_{ext} \, dV$,
...
$$
\dot W_{flow} = \dot W_{in} + \dot W_{out}
...
Net flow work rate:
$$
\dot W_{flow} = 1{,}000~\text{J/min} \approx 16.7~\text{W}
$$
