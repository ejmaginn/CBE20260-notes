...
![Schematic of a boiler (or furnace). Heat (usually from combustion) is transferred to water in tubes, creating high pressure steam that can be used to power turbines or provide heating.](images/water-boiler.png){#fig-water-boiler width=60%}
