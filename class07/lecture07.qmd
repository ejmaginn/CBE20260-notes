...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ejmaginn/CBE20260-notes/blob/main/class07/VDW-loop.ipynb)
:::
...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ejmaginn/CBE20260-notes/blob/main/class07/vdw-TP.ipynb)
...
$$
\begin{aligned}
\frac{d}{dt} \left [ M \left (\hat{U} + \frac{v^2}{2} + gh \right )  \right ] &= 
...
$$
\begin{aligned}
\Delta \left [ M \left (\hat{U} + \frac{v^2}{2} + gh \right )  \right ] &= 
...
$$\frac{d}{dt} \left [ M \left (\hat{U} + \frac{v^2}{2} + gh \right )  \right ]=0$$ {#eq-steady-state}

and
$$\Delta \left [ M \left (\hat{U} + \frac{v^2}{2} + gh \right )  \right ] =0$$ {#eq-steady-state-delta}
